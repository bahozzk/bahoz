  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl shadow p-6 mb-6">
        ...
        <div className="mt-4 text-gray-800 leading-relaxed">
          ...
          <ul className="list-disc ml-6 mt-2 space-y-1">
            ...
            <li>Her hamlede yeni bir kutucuk belirir. Stratejini iyi kurmalısın.</li>
          ...
          <p>
            Kendi rekorunu kır, arkadaşlarınla skorlarını kıyasla ve daha yüksek
            sayılara ulaşmak için stratejini geliştir. Her oyun yeni bir meydan
            okuma!
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow">
        ...
        {isOpen && (
          <div className="px-6 pb-6 text-gray-800 space-y-4">
            <p>
            ...
            <p>
              Gizlilik politikası zaman zaman güncellenebilir. Güncellenmiş
              politika bu sayfada yayınlandığı anda geçerlidir.
            </p>
